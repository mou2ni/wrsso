 ...
 */
class Version20180704095239 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE Comptes (id INT AUTO_INCREMENT NOT NULL, id_client_id INT NOT NULL, num_compte VARCHAR(255) NOT NULL, intitule VARCHAR(255) NOT NULL, solde_courant DOUBLE PRECISION NOT NULL, type_compte VARCHAR(255) NOT NULL, INDEX IDX_99CE619D99DED506 (id_client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE TransactionComptes (id INT AUTO_INCREMENT NOT NULL, id_trans_id INT NOT NULL, id_compte_id INT NOT NULL, num_compte VARCHAR(255) NOT NULL, m_debit DOUBLE PRECISION NOT NULL, m_credit DOUBLE PRECISION NOT NULL, INDEX IDX_4BC64C6E63346B17 (id_trans_id), INDEX IDX_4BC64C6E72F0DA07 (id_compte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Transactions (id INT AUTO_INCREMENT NOT NULL, id_utilisateur_id INT NOT NULL, libelle VARCHAR(255) NOT NULL, date_transaction DATETIME NOT NULL, INDEX IDX_F299C1B4C6EE5C49 (id_utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
