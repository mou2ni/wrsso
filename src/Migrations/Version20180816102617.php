 ...
 */
final class Version20180816102617 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE BilletageLignes (id INT AUTO_INCREMENT NOT NULL, id_billetage_id INT NOT NULL, billet_id INT NOT NULL, valeur_billet DOUBLE PRECISION NOT NULL, nb_billet INT NOT NULL, valeur_ligne DOUBLE PRECISION NOT NULL, INDEX IDX_612BF20E3B06492F (id_billetage_id), INDEX IDX_612BF20E44973C78 (billet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Caisses (id INT AUTO_INCREMENT NOT NULL, compte_operation_id INT NOT NULL, id_cpt_cv_devise INT DEFAULT NULL, journee_ouverte_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, INDEX IDX_41BE1F462886B1E4 (compte_operation_id), INDEX IDX_41BE1F468A8E563 (id_cpt_cv_devise), UNIQUE INDEX UNIQ_41BE1F46D5D3F181 (journee_ouverte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE DetteCreditDivers (id INT AUTO_INCREMENT NOT NULL, caisse_id INT NOT NULL, date_dc DATETIME NOT NULL, libelle VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, m_credit DOUBLE PRECISION NOT NULL, m_dette DOUBLE PRECISION NOT NULL, journeeCaissesCreation INT NOT NULL, journeeCaisseRemb INT NOT NULL, INDEX IDX_1C5147F227B4FEBF (caisse_id), INDEX IDX_1C5147F2C22CD53D (journeeCaissesCreation), INDEX IDX_1C5147F2C8127358 (journeeCaisseRemb), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE JourneeCaisses (id INT AUTO_INCREMENT NOT NULL, caisse_id INT NOT NULL, utilisateur_id INT NOT NULL, journee_suivante_id INT DEFAULT NULL, billet_ouv_id INT DEFAULT NULL, system_elect_invent_ouv_id INT DEFAULT NULL, billet_ferm_id INT DEFAULT NULL, system_elect_invent_ferm_id INT DEFAULT NULL, date_ouv DATETIME NOT NULL, statut VARCHAR(255) NOT NULL, valeur_billet BIGINT NOT NULL, solde_elect_ouv BIGINT NOT NULL, ecart_ouv BIGINT NOT NULL, m_cvd DOUBLE PRECISION NOT NULL, m_emission_trans BIGINT NOT NULL, m_reception_trans BIGINT NOT NULL, m_intercaisse BIGINT NOT NULL, m_retrait_client BIGINT NOT NULL, m_depot_client BIGINT NOT NULL, m_credit_divers BIGINT NOT NULL, m_dette_divers BIGINT NOT NULL, date_ferm DATETIME DEFAULT NULL, valeur_billet_ferm BIGINT NOT NULL, solde_elect_ferm BIGINT NOT NULL, m_ecart_ferm BIGINT NOT NULL, INDEX IDX_EC12D8DF27B4FEBF (caisse_id), INDEX IDX_EC12D8DFFB88E14F (utilisateur_id), INDEX IDX_EC12D8DF843321D9 (journee_suivante_id), UNIQUE INDEX UNIQ_EC12D8DFB1826C82 (billet_ouv_id), UNIQUE INDEX UNIQ_EC12D8DF2FFAA428 (system_elect_invent_ouv_id), UNIQUE INDEX UNIQ_EC12D8DF377E1C61 (billet_ferm_id), INDEX IDX_EC12D8DF1E32E5F (system_elect_invent_ferm_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Transactions (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, date_transaction DATETIME NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, idUtilisateur INT NOT NULL, idUtilisateurLast INT DEFAULT NULL, INDEX IDX_F299C1B45D419CCB (idUtilisateur), INDEX IDX_F299C1B443147D00 (idUtilisateurLast), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE TransfertInternationaux (id INT AUTO_INCREMENT NOT NULL, id_system_transfert_id INT NOT NULL, id_pays_id INT NOT NULL, sens VARCHAR(255) NOT NULL, m_transfert VARCHAR(255) NOT NULL, m_frais_ht VARCHAR(255) NOT NULL, m_tva VARCHAR(255) NOT NULL, m_autres_taxes VARCHAR(255) NOT NULL, idJourneeCaisse INT NOT NULL, INDEX IDX_CD12576A7DA9E4F (idJourneeCaisse), INDEX IDX_CD12576A6945FF6B (id_system_transfert_id), INDEX IDX_CD12576A7879EB34 (id_pays_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Utilisateurs (id INT AUTO_INCREMENT NOT NULL, id_cpt_ecart INT NOT NULL, journee_caisse_active_id INT DEFAULT NULL, last_caisse_id INT DEFAULT NULL, login VARCHAR(255) NOT NULL, mdp VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, est_caissier TINYINT(1) NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_514AEAA6314865F4 (id_cpt_ecart), UNIQUE INDEX UNIQ_514AEAA6B451A8DB (journee_caisse_active_id), INDEX IDX_514AEAA6307B21B9 (last_caisse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
