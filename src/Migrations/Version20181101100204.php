 ...
 */
final class Version20181101100204 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateurs CHANGE journee_caisse_active journee_caisse_active_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Utilisateurs CHANGE journee_caisse_active_id journee_caisse_active INT NOT NULL');
    }
}
