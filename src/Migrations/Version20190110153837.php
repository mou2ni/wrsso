 ...
 */
final class Version20190110153837 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Caisses (id INT AUTO_INCREMENT NOT NULL, compte_operation_id INT NOT NULL, id_cpt_cv_devise INT DEFAULT NULL, compte_intercaisse_id INT DEFAULT NULL, compte_attente_compense_id INT DEFAULT NULL, last_journee_id INT DEFAULT NULL, last_utilisateur_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, INDEX IDX_41BE1F462886B1E4 (compte_operation_id), INDEX IDX_41BE1F468A8E563 (id_cpt_cv_devise), INDEX IDX_41BE1F46F2823676 (compte_intercaisse_id), INDEX IDX_41BE1F46E8526BE8 (compte_attente_compense_id), UNIQUE INDEX UNIQ_41BE1F4626720BA2 (last_journee_id), INDEX IDX_41BE1F46958FE8CB (last_utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
