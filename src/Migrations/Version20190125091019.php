 ...
 */
final class Version20190125091019 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE type_operation_comptables (id INT AUTO_INCREMENT NOT NULL, compte_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, est_charge TINYINT(1) NOT NULL, INDEX IDX_C0FB3AA4F2C56620 (compte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
