 ...
 */
final class Version20190219141409 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Caisses (id INT AUTO_INCREMENT NOT NULL, compte_operation_id INT NOT NULL, journal_comptable_id INT DEFAULT NULL, id_cpt_cv_devise INT DEFAULT NULL, compte_intercaisse_id INT DEFAULT NULL, compte_attente_compense_id INT DEFAULT NULL, last_journee_id INT DEFAULT NULL, last_utilisateur_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, type_caisse VARCHAR(255) NOT NULL, dispo_guichet TINYINT(1) NOT NULL, compta_detail TINYINT(1) NOT NULL, INDEX IDX_41BE1F462886B1E4 (compte_operation_id), INDEX IDX_41BE1F46699E1206 (journal_comptable_id), INDEX IDX_41BE1F468A8E563 (id_cpt_cv_devise), INDEX IDX_41BE1F46F2823676 (compte_intercaisse_id), INDEX IDX_41BE1F46E8526BE8 (compte_attente_compense_id), UNIQUE INDEX UNIQ_41BE1F4626720BA2 (last_journee_id), INDEX IDX_41BE1F46958FE8CB (last_utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Clients (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, type_tier VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE collaborateurs (id INT AUTO_INCREMENT NOT NULL, compte_virement_id INT DEFAULT NULL, compte_remuneration_due_id INT DEFAULT NULL, entreprise_id INT DEFAULT NULL, dernier_salaire_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE DEFAULT NULL, qualite VARCHAR(255) DEFAULT NULL, est_representant TINYINT(1) NOT NULL, date_entree DATE DEFAULT NULL, date_sortie DATE DEFAULT NULL, statut VARCHAR(255) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, nb_enfant INT NOT NULL, categorie VARCHAR(255) NOT NULL, n_securite_sociale VARCHAR(255) NOT NULL, m_salaire_base DOUBLE PRECISION NOT NULL, m_indem_logement DOUBLE PRECISION NOT NULL, m_indem_transport DOUBLE PRECISION NOT NULL, m_indem_fonction DOUBLE PRECISION NOT NULL, m_indem_autres DOUBLE PRECISION NOT NULL, m_heure_sup DOUBLE PRECISION NOT NULL, m_securite_sociale_salarie DOUBLE PRECISION NOT NULL, m_securite_sociale_patronal DOUBLE PRECISION NOT NULL, m_impot_salarie DOUBLE PRECISION NOT NULL, m_taxe_patronale DOUBLE PRECISION NOT NULL, INDEX IDX_4A340D9D3AA9837 (compte_virement_id), INDEX IDX_4A340D9297A0144 (compte_remuneration_due_id), INDEX IDX_4A340D9A4AEAFEA (entreprise_id), INDEX IDX_4A340D92C2A202F (dernier_salaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE depot_retraits (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, transaction_id INT DEFAULT NULL, journee_caisse_id INT NOT NULL, compte_operation_caisse_id INT NOT NULL, compte_client_id INT DEFAULT NULL, date_operation DATETIME NOT NULL, libelle VARCHAR(255) NOT NULL, num_compte_saisie VARCHAR(50) NOT NULL, m_depot DOUBLE PRECISION NOT NULL, m_retrait DOUBLE PRECISION NOT NULL, statut VARCHAR(2) NOT NULL, INDEX IDX_80A0AD9DFB88E14F (utilisateur_id), INDEX IDX_80A0AD9D2FC0CB0F (transaction_id), INDEX IDX_80A0AD9DED9240C0 (journee_caisse_id), INDEX IDX_80A0AD9D85E92CE6 (compte_operation_caisse_id), INDEX IDX_80A0AD9DDA655713 (compte_client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE DeviseIntercaisses (id INT AUTO_INCREMENT NOT NULL, journee_caisse_source_id INT NOT NULL, journee_caisse_destination_id INT NOT NULL, journee_caisse_initiateur_id INT DEFAULT NULL, date_intercaisse DATETIME NOT NULL, statut VARCHAR(255) NOT NULL, observations VARCHAR(255) DEFAULT NULL, INDEX IDX_D7381A146AE367D (journee_caisse_source_id), INDEX IDX_D7381A144F08E1DE (journee_caisse_destination_id), INDEX IDX_D7381A1453B5438B (journee_caisse_initiateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Devises (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, libelle VARCHAR(255) NOT NULL, date_modification DATETIME NOT NULL, tx_achat DOUBLE PRECISION NOT NULL, tx_reference DOUBLE PRECISION DEFAULT NULL, tx_vente DOUBLE PRECISION NOT NULL, formule_achat VARCHAR(255) NOT NULL, formule_vente VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE entreprises (id INT AUTO_INCREMENT NOT NULL, representant_id INT DEFAULT NULL, code VARCHAR(255) NOT NULL, libelle VARCHAR(255) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, INDEX IDX_56B1B7A96C4A52F0 (representant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE journaux_comptables (id INT AUTO_INCREMENT NOT NULL, compte_contre_partie_id INT DEFAULT NULL, code VARCHAR(50) NOT NULL, type_journal VARCHAR(50) NOT NULL, libelle VARCHAR(255) NOT NULL, dernier_num_piece INT NOT NULL, UNIQUE INDEX UNIQ_EEB485E977153098 (code), INDEX IDX_EEB485E91BBCBE86 (compte_contre_partie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ligne_salaires (id INT AUTO_INCREMENT NOT NULL, transaction_id INT DEFAULT NULL, salaire_id INT DEFAULT NULL, compte_virement_id INT DEFAULT NULL, compte_remuneration_due_id INT DEFAULT NULL, collaborateur_id INT DEFAULT NULL, m_salaire_base DOUBLE PRECISION NOT NULL, m_indem_logement DOUBLE PRECISION NOT NULL, m_indem_transport DOUBLE PRECISION NOT NULL, m_indem_fonction DOUBLE PRECISION NOT NULL, m_indem_autres DOUBLE PRECISION NOT NULL, m_heure_sup DOUBLE PRECISION NOT NULL, m_securite_sociale_salarie DOUBLE PRECISION NOT NULL, m_securite_sociale_patronal DOUBLE PRECISION NOT NULL, m_impot_salarie DOUBLE PRECISION NOT NULL, m_taxe_patronale DOUBLE PRECISION NOT NULL, INDEX IDX_2E1F35722FC0CB0F (transaction_id), INDEX IDX_2E1F35722678C781 (salaire_id), INDEX IDX_2E1F3572D3AA9837 (compte_virement_id), INDEX IDX_2E1F3572297A0144 (compte_remuneration_due_id), INDEX IDX_2E1F3572A848E3B1 (collaborateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ParamComptables (id INT AUTO_INCREMENT NOT NULL, id_cpt_intercaisse INT DEFAULT NULL, id_cpt_cvd INT DEFAULT NULL, id_cpt_compense INT DEFAULT NULL, compte_charge_base_salaire_id INT DEFAULT NULL, compte_charge_loge_salaire_id INT DEFAULT NULL, compte_charge_transp_salaire_id INT DEFAULT NULL, compte_charge_fonct_salaire_id INT DEFAULT NULL, compte_charge_indem_salaire_id INT DEFAULT NULL, compte_charge_coti_patronale_id INT DEFAULT NULL, compte_taxe_salaire_id INT DEFAULT NULL, compte_orga_social_id INT DEFAULT NULL, compte_orga_impot_salaire_id INT DEFAULT NULL, compte_orga_taxe_salaire_id INT DEFAULT NULL, compte_remuneration_due_id INT DEFAULT NULL, compte_orga_taxe_fact_clt_id INT DEFAULT NULL, compte_orga_taxe_fact_fseur_id INT DEFAULT NULL, id_cpt_ecart INT DEFAULT NULL, id_cpt_charges INT DEFAULT NULL, id_cpt_produits INT DEFAULT NULL, entreprise_id INT DEFAULT NULL, journal_paye_id INT DEFAULT NULL, code_structure VARCHAR(255) NOT NULL, INDEX IDX_DED38F081A661CCE (id_cpt_intercaisse), INDEX IDX_DED38F08149A7A04 (id_cpt_cvd), INDEX IDX_DED38F08B2EACDB5 (id_cpt_compense), INDEX IDX_DED38F085A6C77A0 (compte_charge_base_salaire_id), INDEX IDX_DED38F0883AF619 (compte_charge_loge_salaire_id), INDEX IDX_DED38F08C34758D1 (compte_charge_transp_salaire_id), INDEX IDX_DED38F08286A8BF9 (compte_charge_fonct_salaire_id), INDEX IDX_DED38F08FC18E500 (compte_charge_indem_salaire_id), INDEX IDX_DED38F0866CC6179 (compte_charge_coti_patronale_id), INDEX IDX_DED38F08FD5FA9C3 (compte_taxe_salaire_id), INDEX IDX_DED38F088D5E0397 (compte_orga_social_id), INDEX IDX_DED38F08A51C551A (compte_orga_impot_salaire_id), INDEX IDX_DED38F085BE3757A (compte_orga_taxe_salaire_id), INDEX IDX_DED38F08297A0144 (compte_remuneration_due_id), INDEX IDX_DED38F08F04745FB (compte_orga_taxe_fact_clt_id), INDEX IDX_DED38F087B6CC449 (compte_orga_taxe_fact_fseur_id), INDEX IDX_DED38F08314865F4 (id_cpt_ecart), INDEX IDX_DED38F08CA20F56D (id_cpt_charges), INDEX IDX_DED38F0870BCF4B6 (id_cpt_produits), INDEX IDX_DED38F08A4AEAFEA (entreprise_id), INDEX IDX_DED38F0832D04E2 (journal_paye_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Pays (id INT AUTO_INCREMENT NOT NULL, zone_id INT DEFAULT NULL, code VARCHAR(5) DEFAULT NULL, libelle VARCHAR(255) NOT NULL, dans_region TINYINT(1) NOT NULL, ordre INT DEFAULT NULL, UNIQUE INDEX UNIQ_94AD939077153098 (code), INDEX IDX_94AD93909F2C3FAB (zone_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE recette_depenses (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, type_operation_comptable_id INT DEFAULT NULL, transaction_id INT DEFAULT NULL, journee_caisse_id INT DEFAULT NULL, compte_gestion_id INT DEFAULT NULL, compte_tier_id INT DEFAULT NULL, date_operation DATETIME NOT NULL, libelle VARCHAR(255) NOT NULL, m_recette DOUBLE PRECISION NOT NULL, m_depense DOUBLE PRECISION NOT NULL, statut VARCHAR(255) NOT NULL, est_comptant TINYINT(1) NOT NULL, INDEX IDX_5E21EE33FB88E14F (utilisateur_id), INDEX IDX_5E21EE338209B870 (type_operation_comptable_id), INDEX IDX_5E21EE332FC0CB0F (transaction_id), INDEX IDX_5E21EE33ED9240C0 (journee_caisse_id), INDEX IDX_5E21EE3342C92C7D (compte_gestion_id), INDEX IDX_5E21EE331B33C58A (compte_tier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Salaires (id INT AUTO_INCREMENT NOT NULL, periode_salaire VARCHAR(50) NOT NULL, date_salaire DATE NOT NULL, m_brut_total DOUBLE PRECISION NOT NULL, m_taxe_total DOUBLE PRECISION NOT NULL, m_impot_total DOUBLE PRECISION NOT NULL, m_securite_social_salarie DOUBLE PRECISION NOT NULL, m_securite_social_patronal DOUBLE PRECISION NOT NULL, statut VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_88F3461291D72643 (periode_salaire), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE SystemTransfert (id INT AUTO_INCREMENT NOT NULL, banque_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, INDEX IDX_5350E46437E080D9 (banque_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE TransactionComptes (id INT AUTO_INCREMENT NOT NULL, num_compte VARCHAR(255) NOT NULL, libelle VARCHAR(255) DEFAULT NULL, m_debit DOUBLE PRECISION DEFAULT NULL, m_credit DOUBLE PRECISION DEFAULT NULL, IdCompte INT NOT NULL, IdTransaction INT NOT NULL, INDEX IDX_4BC64C6E559198AC (IdCompte), INDEX IDX_4BC64C6E8114B15C (IdTransaction), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Transactions (id INT AUTO_INCREMENT NOT NULL, journaux_comptable_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, num_piece VARCHAR(50) DEFAULT NULL, m_debit_total DOUBLE PRECISION DEFAULT NULL, m_credit_total DOUBLE PRECISION DEFAULT NULL, date_transaction DATETIME NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, idUtilisateur INT NOT NULL, idJourneeCaisse INT DEFAULT NULL, idUtilisateurLast INT DEFAULT NULL, UNIQUE INDEX UNIQ_F299C1B4349BA55 (num_piece), INDEX IDX_F299C1B45D419CCB (idUtilisateur), INDEX IDX_F299C1B47DA9E4F (idJourneeCaisse), INDEX IDX_F299C1B49C00096A (journaux_comptable_id), INDEX IDX_F299C1B443147D00 (idUtilisateurLast), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE TransfertInternationaux (id INT AUTO_INCREMENT NOT NULL, id_pays_id INT NOT NULL, transaction_id INT DEFAULT NULL, sens VARCHAR(255) NOT NULL, m_transfert DOUBLE PRECISION NOT NULL, m_frais_ht DOUBLE PRECISION NOT NULL, m_tva DOUBLE PRECISION NOT NULL, m_autres_taxes DOUBLE PRECISION NOT NULL, m_transfert_ttc DOUBLE PRECISION NOT NULL, journeeCaisse INT NOT NULL, journeeCaisseEmi INT DEFAULT NULL, journeeCaisseRecu INT DEFAULT NULL, idSystemTransfert INT NOT NULL, INDEX IDX_CD12576ACD3EC261 (journeeCaisse), INDEX IDX_CD12576A1C955392 (journeeCaisseEmi), INDEX IDX_CD12576AD542DB11 (journeeCaisseRecu), INDEX IDX_CD12576AB24F04ED (idSystemTransfert), INDEX IDX_CD12576A7879EB34 (id_pays_id), INDEX IDX_CD12576A2FC0CB0F (transaction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE zones (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, ordre INT NOT NULL, detail TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE Caisses ADD CONSTRAINT FK_41BE1F46699E1206 FOREIGN KEY (journal_comptable_id) REFERENCES journaux_comptables (id)');
        ...
        $this->addSql('ALTER TABLE collaborateurs ADD CONSTRAINT FK_4A340D9297A0144 FOREIGN KEY (compte_remuneration_due_id) REFERENCES Comptes (id)');
        ...
        $this->addSql('ALTER TABLE depot_retraits ADD CONSTRAINT FK_80A0AD9DFB88E14F FOREIGN KEY (utilisateur_id) REFERENCES Utilisateurs (id)');
        $this->addSql('ALTER TABLE depot_retraits ADD CONSTRAINT FK_80A0AD9D2FC0CB0F FOREIGN KEY (transaction_id) REFERENCES Transactions (id)');
        $this->addSql('ALTER TABLE depot_retraits ADD CONSTRAINT FK_80A0AD9DED9240C0 FOREIGN KEY (journee_caisse_id) REFERENCES JourneeCaisses (id)');
        $this->addSql('ALTER TABLE depot_retraits ADD CONSTRAINT FK_80A0AD9D85E92CE6 FOREIGN KEY (compte_operation_caisse_id) REFERENCES Comptes (id)');
        $this->addSql('ALTER TABLE depot_retraits ADD CONSTRAINT FK_80A0AD9DDA655713 FOREIGN KEY (compte_client_id) REFERENCES Comptes (id)');
        ...
        $this->addSql('ALTER TABLE journaux_comptables ADD CONSTRAINT FK_EEB485E91BBCBE86 FOREIGN KEY (compte_contre_partie_id) REFERENCES Comptes (id)');
        ...
        $this->addSql('ALTER TABLE ligne_salaires ADD CONSTRAINT FK_2E1F35722FC0CB0F FOREIGN KEY (transaction_id) REFERENCES Transactions (id)');
        ...
        $this->addSql('ALTER TABLE ligne_salaires ADD CONSTRAINT FK_2E1F3572297A0144 FOREIGN KEY (compte_remuneration_due_id) REFERENCES Comptes (id)');
        ...
        $this->addSql('ALTER TABLE ParamComptables ADD CONSTRAINT FK_DED38F08297A0144 FOREIGN KEY (compte_remuneration_due_id) REFERENCES Comptes (id)');
        ...
        $this->addSql('ALTER TABLE ParamComptables ADD CONSTRAINT FK_DED38F0832D04E2 FOREIGN KEY (journal_paye_id) REFERENCES journaux_comptables (id)');
        $this->addSql('ALTER TABLE Pays ADD CONSTRAINT FK_94AD93909F2C3FAB FOREIGN KEY (zone_id) REFERENCES zones (id)');
        ...
        $this->addSql('ALTER TABLE recette_depenses ADD CONSTRAINT FK_5E21EE3342C92C7D FOREIGN KEY (compte_gestion_id) REFERENCES Comptes (id)');
        $this->addSql('ALTER TABLE recette_depenses ADD CONSTRAINT FK_5E21EE331B33C58A FOREIGN KEY (compte_tier_id) REFERENCES Comptes (id)');
        ...
        $this->addSql('ALTER TABLE Transactions ADD CONSTRAINT FK_F299C1B49C00096A FOREIGN KEY (journaux_comptable_id) REFERENCES journaux_comptables (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE collaborateurs DROP FOREIGN KEY FK_4A340D9D3AA9837');
        $this->addSql('ALTER TABLE collaborateurs DROP FOREIGN KEY FK_4A340D9297A0144');
        $this->addSql('ALTER TABLE depot_retraits DROP FOREIGN KEY FK_80A0AD9D85E92CE6');
        $this->addSql('ALTER TABLE depot_retraits DROP FOREIGN KEY FK_80A0AD9DDA655713');
        $this->addSql('ALTER TABLE journaux_comptables DROP FOREIGN KEY FK_EEB485E91BBCBE86');
        $this->addSql('ALTER TABLE ligne_salaires DROP FOREIGN KEY FK_2E1F3572D3AA9837');
        $this->addSql('ALTER TABLE ligne_salaires DROP FOREIGN KEY FK_2E1F3572297A0144');
        ...
        $this->addSql('ALTER TABLE ParamComptables DROP FOREIGN KEY FK_DED38F08297A0144');
        ...
        $this->addSql('ALTER TABLE recette_depenses DROP FOREIGN KEY FK_5E21EE3342C92C7D');
        $this->addSql('ALTER TABLE recette_depenses DROP FOREIGN KEY FK_5E21EE331B33C58A');
        ...
        $this->addSql('ALTER TABLE Caisses DROP FOREIGN KEY FK_41BE1F46699E1206');
        $this->addSql('ALTER TABLE ParamComptables DROP FOREIGN KEY FK_DED38F0832D04E2');
        $this->addSql('ALTER TABLE Transactions DROP FOREIGN KEY FK_F299C1B49C00096A');
        $this->addSql('ALTER TABLE Caisses DROP FOREIGN KEY FK_41BE1F4626720BA2');
        $this->addSql('ALTER TABLE depot_retraits DROP FOREIGN KEY FK_80A0AD9DED9240C0');
        ...
        $this->addSql('ALTER TABLE collaborateurs DROP FOREIGN KEY FK_4A340D92C2A202F');
        ...
        $this->addSql('ALTER TABLE depot_retraits DROP FOREIGN KEY FK_80A0AD9D2FC0CB0F');
        $this->addSql('ALTER TABLE InterCaisses DROP FOREIGN KEY FK_F4C41EC2FC0CB0F');
        $this->addSql('ALTER TABLE ligne_salaires DROP FOREIGN KEY FK_2E1F35722FC0CB0F');
        ...
        $this->addSql('ALTER TABLE depot_retraits DROP FOREIGN KEY FK_80A0AD9DFB88E14F');
        ...
        $this->addSql('DROP TABLE depot_retraits');
        ...
        $this->addSql('DROP TABLE journaux_comptables');
