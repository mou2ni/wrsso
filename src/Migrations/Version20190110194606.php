 ...
 */
final class Version20190110194606 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comptes CHANGE intitule intitule VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Comptes CHANGE intitule intitule VARCHAR(250) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
