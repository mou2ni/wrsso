 ...
 */
final class Version20190201191301 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Caisses (id INT AUTO_INCREMENT NOT NULL, compte_operation_id INT NOT NULL, id_cpt_cv_devise INT DEFAULT NULL, compte_intercaisse_id INT DEFAULT NULL, compte_attente_compense_id INT DEFAULT NULL, last_journee_id INT DEFAULT NULL, last_utilisateur_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, type_caisse VARCHAR(255) NOT NULL, dispo_guichet TINYINT(1) NOT NULL, INDEX IDX_41BE1F462886B1E4 (compte_operation_id), INDEX IDX_41BE1F468A8E563 (id_cpt_cv_devise), INDEX IDX_41BE1F46F2823676 (compte_intercaisse_id), INDEX IDX_41BE1F46E8526BE8 (compte_attente_compense_id), UNIQUE INDEX UNIQ_41BE1F4626720BA2 (last_journee_id), INDEX IDX_41BE1F46958FE8CB (last_utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Salaires (id INT AUTO_INCREMENT NOT NULL, transaction_id INT NOT NULL, periode_salaire DATE NOT NULL, m_net_total DOUBLE PRECISION NOT NULL, m_taxe_total DOUBLE PRECISION NOT NULL, m_impot_total DOUBLE PRECISION NOT NULL, m_securite_social_total DOUBLE PRECISION NOT NULL, statut VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_88F3461291D72643 (periode_salaire), INDEX IDX_88F346122FC0CB0F (transaction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
