 ...
 */
final class Version20190209135430 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE depot_retraits (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, transaction_id INT DEFAULT NULL, compte_operation_caisse_id INT NOT NULL, compte_client_id INT DEFAULT NULL, date_operation DATETIME NOT NULL, libelle VARCHAR(255) NOT NULL, m_depot DOUBLE PRECISION NOT NULL, m_retrait DOUBLE PRECISION NOT NULL, statut VARCHAR(2) NOT NULL, INDEX IDX_80A0AD9DFB88E14F (utilisateur_id), INDEX IDX_80A0AD9D2FC0CB0F (transaction_id), INDEX IDX_80A0AD9D85E92CE6 (compte_operation_caisse_id), INDEX IDX_80A0AD9DDA655713 (compte_client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Devises (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, libelle VARCHAR(255) NOT NULL, date_modification DATETIME NOT NULL, tx_achat DOUBLE PRECISION NOT NULL, tx_reference DOUBLE PRECISION DEFAULT NULL, tx_vente DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE entreprises (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, libelle VARCHAR(255) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Pays (id INT AUTO_INCREMENT NOT NULL, zone_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, dans_region TINYINT(1) NOT NULL, INDEX IDX_94AD93909F2C3FAB (zone_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE recette_depenses (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, type_operation_comptable_id INT DEFAULT NULL, transaction_id INT DEFAULT NULL, journee_caisse_id INT NOT NULL, compte_tier_id INT DEFAULT NULL, date_operation DATETIME NOT NULL, libelle VARCHAR(255) NOT NULL, m_recette DOUBLE PRECISION NOT NULL, m_depense DOUBLE PRECISION NOT NULL, statut VARCHAR(255) NOT NULL, est_comptant TINYINT(1) NOT NULL, INDEX IDX_5E21EE33FB88E14F (utilisateur_id), INDEX IDX_5E21EE338209B870 (type_operation_comptable_id), INDEX IDX_5E21EE332FC0CB0F (transaction_id), INDEX IDX_5E21EE33ED9240C0 (journee_caisse_id), INDEX IDX_5E21EE331B33C58A (compte_tier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE TransactionComptes (id INT AUTO_INCREMENT NOT NULL, num_compte VARCHAR(255) NOT NULL, libelle VARCHAR(255) DEFAULT NULL, m_debit DOUBLE PRECISION DEFAULT NULL, m_credit DOUBLE PRECISION DEFAULT NULL, m_solde_avant DOUBLE PRECISION DEFAULT NULL, IdCompte INT NOT NULL, IdTransaction INT NOT NULL, INDEX IDX_4BC64C6E559198AC (IdCompte), INDEX IDX_4BC64C6E8114B15C (IdTransaction), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE zones (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, ordre INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
